	...
	$.fn.lightbox = function(options) {
		...
		*/
		function getPageSize() {
			var jqueryPageSize = new Array($(document).width(),$(document).height(), $(window).width=800, $(window).height=900);
		...
		*/
		...
		$.fn.lightbox.defaults = {
			allSet: false,
			fileLoadingImage: '../../../../javascripts/ligthbox/images/loading.gif',
			fileBottomNavCloseImage: '../../../../javascripts/ligthbox/images/closelabel.gif',
			overlayOpacity: 0.6,
			borderSize: 10,
