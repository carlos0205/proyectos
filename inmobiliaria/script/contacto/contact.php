...
?>
		      ...
		      <td height="12" valign="top" align="center"  ></td>
				 ...
				 <tr><td align="center"><img src="../../images/contactoweb.png" border="0" /></td></tr>  
				 
				  	  
<tr><td style="padding-left:20px" width="954px" ><table width="954" height="385" border="0" align="center" cellpadding="0" cellspacing="0"  class="textonegro" style="background-image:url(images/fondocontacto.png); background-repeat:no-repeat" >
                            <!--DWLayoutTable-->
                            ...
                            <tr>
                              <td height="29"></td>
					          <td valign="top" style="padding-left:20px" class="textogrisb">Nombres</td>
                            ...
                            <tr>
                              ...
                              <td valign="top" class="textogrisb">Direccion</td>
                              <td valign="top" ><!--DWLayoutEmptyCell-->&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="38"></td>
					          <td valign="top" ><input name="txt1conwebsi"  type="text"  style="background-color:#FFFFFF;  height:20px" class="contactenos-form-textfield2" id="txt1conwebsi" tabindex="0" size="40" maxlength="100" onFocus="style.backgroundColor='#F5F5F5'" onBlur="style.backgroundColor='#FFFFFF'" title="<?php echo $filetiqueta["percontacto"];?> "  /></td>
					          <td valign="top" ><input name="txt1dirconwebsi"  type="text"  style="background-color:#FFFFFF;  height:20px" class="contactenos-form-textfield2"  id="txt1dirconwebsi" tabindex="0" size="30" maxlength="100" onFocus="style.backgroundColor='#F5F5F5'" onBlur="style.backgroundColor='#FFFFFF'" title="<?php echo $filetiqueta["direccion"];?> " /></td>
	                          <td valign="top" ><!--DWLayoutEmptyCell-->&nbsp;</td>
                            </tr>
...
WHERE c.codciu = $ciudad ";
    ...
    $filisc = mysql_fetch_assoc($reslisc);
				   ...
				   <script language = JavaScript>
					alert("El contacto web se envio con exito");
