...
//consulto informacion de subgrupo
	$qryreg = "SELECT d.*, p.cn FROM deppro d, pais p WHERE d.coddep = '$cod' AND d.ci = p.ci";
  ...
  <tr>
    <td height="313" colspan="2" valign="top"><!-- InstanceBeginEditable name="contenido" -->
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td height="65" colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="textonegro">
            <!--DWLayoutTable-->
            <tr>
	...
	<td width="75" rowspan="3" align="center" valign="middle" class="textonegro"><button class="textonegro" name="cancelarno" type="submit" value="cancelar" style="margin: 0px; background-color: transparent; border: none;cursor: pointer;"><img src="../images/cancelar.png" width="32" height="32"  /><br>
            ...
            <tr>
              <td height="26" colspan="2" valign="top" class="textoerror"><div align="right">
				...
				if (isset($_POST['guardarno'])){
					auditoria($_SESSION["enlineaadm"],'Departamentos',$cod,'4');
					actualizar(substr(basename($_SERVER['PHP_SELF']),0,-7),2,$cod,"coddep","deppro.php");
				}
				//boton aplicar cambios
				if (isset($_POST['aplicarno'])){
					auditoria($_SESSION["enlineaadm"],'Departamentos',$cod,'4');
					actualizar(substr(basename($_SERVER['PHP_SELF']),0,-7),2,$cod,"coddep","depproedi.php?cod=$cod");
				}
        ...
        <tr>
          ...
          <td valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1089" height="52" valign="top" class="titulos"><img src="../images/div.png" width="48" height="48" align="absmiddle" />Departamentos [Edita]  <strong>
        ...
        <tr>
          ...
          <td valign="top"><table width="58%" height="152" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="marcotabla" style="width: 100%">
            ...
            <tr>
              <td height="24"></td>
                <td valign="top" ><p>Nombre del Departamento<br>
                  <input name="txt2nomdepsi" type="text" id="txt2nomdepsi" size="40" onChange="javascript:this.value=this.value.toUpperCase();" value = "<?php echo $filreg["nomdep"]; ?>"maxlength="100" title="Departamento" />
                  </p></td>
                <td>&nbsp;</td>
              </tr>
            <tr>
            ...
            <tr>
              <td height="23"></td>
                <td valign="top" >Pa&iacute;s al que pertenence<br>
                  <select name="cbo2cisi" id="cbo2cisi" title="Pais">
                    <?
					$pai =  $filreg["ci"];
					$qrypai = "SELECT p.ci, p.cn FROM pais p WHERE p.ci <> '$pai' ORDER BY p.cn";
					$respai = mysql_query($qrypai, $enlace);
					echo "<option selected value=\"".$filreg["ci"]."\">".$filreg["cn"]."</option>\n";
