...
function edita(script,codigo,acc){
	window.location=''+script+'edi.php?cod='+codigo+'&acc='+acc+'';
}
...
function vererrores(seccion){
	...
	if(popup!=null)
		...
		pagina = "vererrores.php?seccion="+seccion+"";
			
		popup = window.open(pagina,"Errores","scrollbars=yes,status=no,width=" + anchoPopup + ", height=" + altoPopup + ",left = " + laXPopup + ",top = " + laYPopup);
	}