...
if (isset($_POST['filtrar'])){
	...
	$query_registros = "SELECT pim.*,d.nomdiasemana, i.nomidi FROM pagsitefondodiario AS pim
	INNER JOIN idipub AS i ON pim.codidi = i.codidi 
	INNER JOIN diasemana AS d ON pim.coddiasemana = d.coddiasemana WHERE pim.codimgfon > 0 ";
...
$_SESSION['qryfiltrofondodiario']=$query_registros;
}

if (isset($_SESSION['qryfiltrofondodiario'])){ 
$query_registros = $_SESSION['qryfiltrofondodiario'];
}
else{
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="63" colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="textonegro">
			...
			if (isset($_POST['nuevo'])){
				...
				location = "pagsitefondodiariocre.php";
				</script>';
				}
                ...
                <script type="text/javascript" language="javascript1.2">
						var entrar = confirm("¿Desea Eliminar los registros?")
						if (entrar){
							location = "pagsitefondodiarioeli.php?codreg=<?php echo $codreg?>"	
						}
						</script>
                <?php
					}else{
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table border="0" cellpadding="0" cellspacing="0" class="textonegro" style="width: 100%">
            <!--DWLayoutTable-->
            <tr>
              <td width="335" height="52" valign="top" class="titulos"><img src="../images/fondodiario.png" width="48" height="48" align="absmiddle" />Imagen diaria de fondo [ Lista ]  </td>
                <td width="496" valign="top" >D&iacute;a de la semana <br>
                  <label>
                ...
                <td width="236" align="right" valign="bottom" ><input name="filtrar" type="submit" id="filtrar" value="Filtrar"/></td>
                <td width="10" >&nbsp;</td>
            </tr>
            <tr>
              <td height="9"></td>
        ...
        <tr>
          ...
          <td valign="top"><table width="93%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F3F3F3" class="marcotabla" style="width: 100%">
		   ...
		   if($numero == 1 )
				...
				$codreg = $row_registros['codimgfon'];
		   ...
		   ?>
		    <tr onMouseOver="this.style.backgroundColor='#E1EBD8';" class="pointer" onMouseOut="this.style.backgroundColor='#F3F3F3'" title="Editar imagen de sección">
              <td height="21" align="center" valign="top"><input type="checkbox" name="registros[]" value="<?php echo $row_registros['codimgfon']; ?>" /></td>
