...
$qryproidi = "SELECT pd.*, i.nomidi FROM prodet pd, idipub i WHERE pd.codpro = '$cod' AND pd.codidi = '$idi' AND pd.codidi = i.codidi";
$resproidi = mysql_query($qryproidi, $enlace);
$filproidi = mysql_fetch_assoc($resproidi);
...
if (isset($_POST['guardarno'])){
		...
		actualizar("prodet",2,$filproidi["codprodet"],"codprodet","proedi.php?cod=$cod&acc=1");
			

	}
	if (isset($_POST['aplicarno'])){

		actualizar("prodet",2,$filproidi["codprodet"],"codprodet","proediidi.php?cod=$cod&codidi=$idi");
 ...
 ?>   </td>
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1380" height="52" valign="top" class="titulos"><img src="../images/carrito.png" width="48" height="48" align="absmiddle" />Idiomas de Producto: <span class="textoerror"><?php echo $filnom["nompro"];?></span> [Edita] </td>
                </tr>
          </table></td>
          </tr>
          ...
          <td valign="top"><table width="58%" height="339" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="marcotabla" style="width: 100%">
            ...
            <tr>
              ...
              <td valign="top" ><p>Nombre de Producto 
                <input name="txt2nomprosi" type="text" id="txt2nomprosi" size="40" value = "<?php echo $filproidi["nompro"]; ?>"maxlength="100" title="Nombre producto" />
              </p></td>
                  <td>&nbsp;</td>
              <td></td>
            </tr>
            ...
            <tr>
              <td height="23"></td>
              <td valign="top" ><strong>Idioma</strong>: <?php echo $filproidi["nomidi"]; ?></td>
                <td></td>
              <td></td>
            </tr>
            <tr>
...
$oFCKeditor->Value = html_entity_decode( $filproidi["despro"] ) ;
$oFCKeditor->Create() ;
?></td>
            <td>&nbsp;</td>
            </tr>
