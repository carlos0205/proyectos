...
$query_registros = "SELECT l.*, ld.nomlin, u.nomusu FROM linneg AS l
INNER JOIN linnegdet AS ld ON l.codlin = ld.codlin AND ld.codidi = 1 
LEFT JOIN usuadm AS u ON l.codusuadm = u.codusuadm";
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <td height="28" colspan="3" valign="top" class="textoerror"><div align="right">
				...
				if (isset($_POST['eliminar'])){		
					if(!empty($_POST['registros'])) {
						...
						if ( entrar ){
							location = "lineli.php?codreg=<?php echo $codreg?>"	
						}
						</script>
						<?php
					}else{
						echo "Seleccione la línea que desea eliminar";
					}
				}
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1177" height="36" valign="top" class="titulos"><img src="../images/linea.png" width="48" height="48" align="absmiddle" /> Lineas [ Lista ]  </td>
                </tr>
            <tr>
              <td height="9"></td>
            </tr>
          ...
          <td valign="top"><table width="93%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F3F3F3" class="marcotabla" style="width: 100%">
            ...
            <tr>
              <td height="8" colspan="2" valign="top" bgcolor="#000000"></td>
                  <td width="137" valign="top" bgcolor="#000000"></td>
                  <td width="192" valign="top" bgcolor="#000000"></td>
                  <td width="536" valign="top" bgcolor="#000000"></td>
              </tr>
            <tr>
              <td width="36" height="30" valign="middle" bgcolor="#FFFFFF" ><div align="center">item</div></td>
                  <td width="243" valign="middle" bgcolor="#FFFFFF" >L&iacute;nea</td>
                  <td valign="middle" bgcolor="#FFFFFF" >Hits</td>
                  <td valign="middle" bgcolor="#FFFFFF" >Creada</td>
                  <td valign="middle" bgcolor="#FFFFFF" >Creada por </td>
                </tr>
			...
			$codreg = $row_registros['codlin'];
		   ?>
		   <tr onMouseOver="this.style.backgroundColor='#E1EBD8';" class="pointer" onMouseOut="this.style.backgroundColor='#F3F3F3'" title="Editar Línea">
              <td height="21" valign="top"><div align="center">
                <input type="checkbox" name="registros[]" value="<?php echo $codreg; ?>" />
                </div></td>
                    <td valign="top" onClick="edita('<?php echo substr(basename($_SERVER['PHP_SELF']),0,-4)?>','<?php echo $codreg?>',1)"><?php echo $row_registros['nomlin']; ?></td>
                    <td valign="top" onClick="edita('<?php echo substr(basename($_SERVER['PHP_SELF']),0,-4)?>','<?php echo $codreg?>',1)"><?php echo $row_registros['hits']; ?></td>
            ...
            <tr>
              <td height="28" colspan="5" align="center" valign="top" bgcolor="#FFFFFF" class="textonegro"><?php 
