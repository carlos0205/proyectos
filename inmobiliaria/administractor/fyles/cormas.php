      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <td colspan="2" rowspan="2" valign="top" class="textoerror"><div align="right">
				...
				if (isset($_POST['enviarno'])){
					...
					if($continua){ //1	
						...
						if($spam == 2){
							$qryter = "SELECT emater as email FROM tercli WHERE envpro = '2' AND codidi = '$idi' UNION SELECT emaspam as email FROM spam";
						}else{
							$qryter = "SELECT emater as email FROM tercli WHERE envpro = '2' AND codidi = '$idi' ";
						}
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1390" height="52" valign="top" class="titulos"><img src="../images/correo.png" width="48" height="48" align="absmiddle" /> Correo Masivo [Envia]   <strong>
          ...
          <td valign="top"><table width="58%" height="339" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="marcotabla" style="width: 100%">
            ...
            <tr>
              <td width="15" height="13"></td>
                  <td width="284"></td>
                  <td width="360"></td>
                  <td width="472" rowspan="3" align="right" valign="middle"><div id="correo"  align="right"></div></td>
              <td width="17"></td>
            </tr>
            <tr>
              <td height="28"></td>
