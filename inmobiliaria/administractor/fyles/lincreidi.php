...
if (isset($_POST['guardarno'])){
		...
		$siguiente=	guardar("linnegdet",1,"codlindet",2);
		?>
	...
	if (isset($_POST['aplicarno'])){
		...
		$siguiente= guardar("linnegdet",2,"codlindet",2);
		?>
		<script language="javascript1.2" type="text/javascript">
			location = "linediidi.php?cod=<?php echo $cod ?>&codidi=<?php echo $_POST["cbo2codidisi"] ?>";
		</script>
		<?php
 ...
 ?>                
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1162" height="52" valign="top" class="titulos"><img src="../images/linea.png" width="48" height="48" align="absmiddle" />Idiomas de L&iacute;nea: <span class="textoerror"><?php echo $filnom["nomlin"];?></span> [Crea] </td>
                <td width="12">&nbsp;</td>
            </tr>
          </table></td>
          </tr>
          ...
          <td valign="top"><table width="58%" height="339" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="marcotabla" style="width: 100%">
            ...
            <tr>
              ...
              <td valign="top"><p>Nombre de L&iacute;nea 
                  <input name="txt2nomlinsi" type="text" id="txt2nomlinsi" size="40"maxlength="100" title="Nombre de linea" />
                <input name="hid1codlinsi" type="hidden" id="hid1codlinsi" value="<?php echo $cod; ?>">
              </p></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              ...
              <td valign="top">Idioma <span class="textonegro">
                  <select name="cbo2codidisi" id="cbo2codidisi" title="Idioma">
                    ...
                    <?
	$qryidi = "SELECT * FROM idipub WHERE codidi <> '1' AND codidi NOT IN(SELECT codidi FROM linnegdet WHERE codlin = $cod) ORDER BY nomidi ";
...
?>
            ...
            <tr>
              <td height="22"></td>
              <td valign="top">Descripci&oacute;n de l&iacute;nea </td>
              <td></td>
              <td></td>
            </tr>
            <tr>
...
if (isset($_POST['txt1deslinsi'])){
	$oFCKeditor->Value = $_POST['txt1deslinsi'] ;
}
else
{
	$oFCKeditor->Value = "" ;
