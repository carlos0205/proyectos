	  ...
	  <form id="form1" name="form1" method="post" action=""  onSubmit="enviacorreo()" enctype="multipart/form-data">
              ...
              <td height="26" colspan="2" valign="top" class="textoerror"><div align="right">
				...
				if (isset($_POST['enviarno'])){
					...
					{	
						...
						if($tipter <> 0){
							$qryter = "SELECT emaspam FROM spam WHERE codtipter='$tipter' ";
						}else{
							$qryter = "SELECT emaspam FROM spam ";
						}
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1390" height="52" valign="top" class="titulos"><img src="../images/correo.png" width="48" height="48" align="absmiddle" /> Correo masivo - cuentas sin clasificar [Envia]  <strong>
        ...
        <tr>
          ...
          <td valign="top"><table width="58%" height="339" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="marcotabla" style="width: 100%">
            ...
            <tr>
              <td height="28"></td>
              <td valign="top" ><p>Asunto del Mensaje  
            ...
            <tr>
              <td height="28"></td>
              <td colspan="2" valign="top"><label>Archivos Adjuntos</span>:</label>
