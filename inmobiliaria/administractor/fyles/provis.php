...
$query_registros = "SELECT pv.* FROM provis pv WHERE pv.codpro = '$cod' ";

include("general/paginadorinferior.php") ;

//consulto parametros de publicacion
$qrypub= "SELECT proori, promin FROM pubpar";
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="textonegro">
              ...
              <td height="28" colspan="2" valign="top" class="textoerror"><div align="right">
				...
				if (isset($_POST['enviar'])){
					...
					if( $file_name <> ""){
						...
						$ruta_miniaturas = "../productos/vistas/mini";
						$ruta_original = "../productos/vistas";
						...
						if($continua){ //2
							...
							if ($continua){ //3
								...
								if($file_size){
									...
									$qryult = "select max(codprovis) as maximo from provis";
								...
								//actualizo subgrupo
								$qryfotins="INSERT INTO provis VALUES ('0','$cod','$nombre_nuevaimg')";							
						...
						echo "Seleccione la fotografía a cargar";
					}
				}
				if (isset($_POST['eliminar'])){		
					if(!empty($_POST['foto'])) {
						...
						if(entrar){
							location = "proviseli.php?codprovis=<?php echo $codimg?>&codpro=<?php echo $cod?>"	
						}
						</script>
						<?php
					}else{
        ...
        <tr>
          ...
          <td colspan="3" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="939" height="52" valign="top" class="titulos"><img src="../images/vistas.png" width="48" height="48" align="absmiddle" /> Vistas de producto   <span class="textoerror"><?php echo $filnompro['nompro'];?></td>
                <td width="211" align="right" valign="top"><div align="right"><span class="textonegro">Volver a Producto <a href="proedi.php?cod=<?php echo $cod ?>&acc=1"><img src="../images/back.png" width="32" height="32" border="0" align="absmiddle" /></a></span></div></td>
                <td width="14">&nbsp;</td>
            </tr>
            <tr>
              <td height="9"></td>
        ...
        <tr>
          <td height="27"></td>
          <td valign="top">Cargar vista de producto (<?php echo $filpub["proori"]; ?>) pixeles
              <input name="imgfile" type="file" id="imgfile" />
            <input name="enviar" type="submit" id="enviar" value="Cargar" /></td>
          <td></td>
          <td></td>
        </tr>
        <tr>
		...
		$codreg = $row_registros['codprovis'];
		   ?>
                    <td width="35" height="114" valign="top"><div align="center">
                      <input type="checkbox" name="foto[]" value="<?php echo $codreg; ?>" />
                      </div></td>
                        <td width="125" valign="top"><img src="../productos/vistas/mini/<?php echo $row_registros['imgpro'];?>" width="102" height="114" /></td>
