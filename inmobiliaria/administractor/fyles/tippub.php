...
$query_registros = "SELECT * FROM tippub ORDER BY nomtippub";
  ...
  <tr>
	...
	if (isset($_POST['eliminar'])){		
	  ...
	  <script type="text/javascript" language="javascript1.2">
			...
			if(entrar){
				location = "tippubeli.php?codreg=<?php echo $codreg?>"	
			}
			</script>
	  <?php
		}else{
	...
	<!--DWLayoutTable-->
	<tr>
	<td width="1177" height="36" valign="top" class="titulos"><img src="../images/tipopublicacion.png" width="48" height="48" align="absmiddle" />Tipo de publicaci&oacute;n [Lista]  </td>
	</tr>
	<tr>
	<td height="9"></td>
	</tr>
	...
	<td width="1023" valign="top" bgcolor="#000000"></td>
	</tr>
	<tr>
	<td width="37" height="30" valign="middle" bgcolor="#FFFFFF" ><div align="center">item</div></td>
	<td width="126" align="center" valign="middle" bgcolor="#FFFFFF" >Codigo</td>
	<td valign="middle" bgcolor="#FFFFFF" >Tipo de publicaci&oacute;n </td>
	</tr>
	...
	if($totalRows_registros > 0){
		...
		$codreg = $row_registros['codtippub'];
	?>
	<tr onMouseOver="this.style.backgroundColor='#E1EBD8';" class="pointer" onMouseOut="this.style.backgroundColor='#F3F3F3'" title="Editar tipo de cliente">
	<td height="21" valign="top"><div align="center">
	<input type="checkbox" name="registros[]" value="<?php echo $codreg; ?>" />
	</div></td>
	<td align="center" valign="top" onClick="edita('<?php echo substr(basename($_SERVER['PHP_SELF']),0,-4)?>','<?php echo $codreg?>',1)"><?php echo $row_registros['codtippub']; ?></td>
	<td valign="top" onClick="edita('<?php echo substr(basename($_SERVER['PHP_SELF']),0,-4)?>','<?php echo $codreg?>',1)"><?php echo $row_registros['nomtippub']; ?></td></tr>
