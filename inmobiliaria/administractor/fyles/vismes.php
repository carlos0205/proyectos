	  ...
	  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
          ...
          <td height="63" colspan="6" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="textonegro">
            ...
            <tr>
              <td width="8" height="16"></td>
                  <td width="915"></td>
                  <td width="32"></td>
                  <td width="70" rowspan="3" align="center" valign="middle"><a href="general/exportar.php"><img src="../images/exportexcel.png" alt="Exportar Resultados a Excel" width="32" height="32" border="0" /><br>
                  Exportar</a></td>
                  <td width="27"></td>
            </tr>
            <tr>
        ...
        <tr>
          ...
          <td colspan="5" valign="top"><table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <!--DWLayoutTable-->
            <tr>
              <td width="1177" height="36" valign="top" class="titulos"><img src="../images/vismes.png" width="48" height="48" align="absmiddle" /> Estad&iacute;stica visitas por mes </td>
                </tr>
            <tr>
              <td height="9"></td>
            </tr>
        ...
        <tr>
		 ...
		 ?>
          ...
          <td>&nbsp;</td>
          <td valign="top" >Estad&iacute;stica visitas  por mes del a&ntilde;o: 
            <?php  echo $ano; ?>
         </td>
          <td></td>
        </tr>
        ...
        <tr>
          ...
          <td rowspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="textonegro">
			...
			$qryvis="SELECT DATE_FORMAT(fecvis, '%m-%Y') AS fecha, COUNT(codvis) AS visitas FROM vis WHERE DATE_FORMAT(fecvis, '%Y') = '$ano' GROUP BY fecha ORDER BY fecvis ASC"; 
			...
			{
					$chart->addPoint(new Point($filvis["fecha"] , $filvis['visitas']));
			}
		 	$chart->setTitle("Estadisticas detalladas por mes");
			$chart->render("../images/estadisticasmes.png");
	  
		 	?>
                  <br>                
                  <img src="../images/estadisticasmes.png?<?php echo $numero_aleatorio;?>" width="550" height="250"></div></td>
                </tr>
          </table></td>
          <td></td>
        </tr>
        ...
        <tr>
          ...
          <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="textonegro">
            <!--DWLayoutTable-->
            <tr>
              <td width="173" height="24" valign="middle" bgcolor="#FFFFFF" ><div align="center">MES</div></td>
            ...
            <tr>
              <td height="157" colspan="2" valign="top"><div align="center" id="DIAS">
                <?php 
			  $qryvismes="SELECT DATE_FORMAT(fecvis, '%m-%Y') AS fecha, COUNT(codvis) AS visitas FROM vis WHERE DATE_FORMAT(fecvis, '%Y') = '$ano' GROUP BY fecha ORDER BY fecvis ASC"; 
			$resvismes = mysql_query($qryvismes, $enlace);
			echo "<table width=100%>\n";
			echo "<tr>\n";
			echo "<th width=173 ></th><th width=171></th>\n";
			echo "</tr>\n";
			while ($filvismes = mysql_fetch_array($resvismes))
			{
					echo "<tr>\n";
					echo"<td class=textonegro ><strong>".$filvismes["fecha"]."</td>";
					echo "<td class=textonegro align = right>".$filvismes["visitas"]."</td>";
					echo "</tr>";
			}
			echo "</table>\n";
			$_SESSION["consulta"] = $qryvismes;
	  		mysql_free_result($resvismes);
		 	?>
                </div></td>
                </tr>
