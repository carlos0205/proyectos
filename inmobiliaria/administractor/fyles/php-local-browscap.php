...
/*
 ...
 Version 1.4, 2008-01-17, http://alexandre.alapetite.net/doc-alex/php-local-browscap/
...
function get_browser_local($user_agent=null,$return_array=false,$db='../../administractor/fyles/browscap.ini',$cache=false)
{//http://alexandre.alapetite.net/doc-alex/php-local-browscap/
